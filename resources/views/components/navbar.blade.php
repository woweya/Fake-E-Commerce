<nav class="w-full relative p-4 mx-auto ms-auto flex items-center justify-between">
    ...
    <ul class="flex items-center gap-4 container">
        ...
        <div id="dropdownNavbar"
            class="hidden z-10 absolute top-16 right-[16%]  font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-[18rem]">
            <div class="bg-gray-100 p-5 rounded " style="box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.5);">
                @livewire('cart')
            </div>
        </div>
