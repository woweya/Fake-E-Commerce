<x-layout>
    <main
        class="w-full mx-auto text-start flex items-start justify-start mb-12 p-10 rounded">
        <div class="left-side-products-tag">
            ...
            <div class="flex items-start justify-start mb-4">
                <input id="category-{{ $loop->index }}" type="checkbox" value="{{ $category }}" class="category-checkbox w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                <label for="category-{{ $loop->index }}" class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300 capitalize">{{ $category }}</label>
            </div>
        @endforeach
                ...
                <div class="tag-filter-rated">
                    ...
                    <form class="max-w-sm mx-auto">
                        <label for="rating-filter" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select an option</label>
                        <select id="rating-filter" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                @foreach ($data as $product)
                    <div class="card-product"
                        ...
                        <div class="card-product-body">
                            ...
                            <p class="card-product-price font-semibold text-xl text-red-800">{{ $product['price'] }}$</p>
                            @php
