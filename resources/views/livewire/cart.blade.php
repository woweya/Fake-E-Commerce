<div >
    ...
    <ul class="flex flex-col flex-nowrap justify-center items-center gap-5">
        @foreach ($cart['products'] as $product)
        <div class="flex flex-nowrap justify-center items-center gap-0 m-0">
        <div class="left-cart-side" style="float:left; width: 50%; height: 100%;">
            <img style="max-width: 50px; max-height: 50px;" width="150" height="150" src="{{ $product['image'] }}" alt="">
        </div>
        <div class="right-cart-side w-full" style="float:right; width: 50%; height: 100%;">
            <p class="text-md font-bold capitalize w-full">{{ Str::limit($product['title'], 14) }}</p>
            ...
            <div class="quantity-product flex items-center justify-start">
                ...
                <div class="right-side-quantity flex flex-col items-center justify-start h-full m-0">
                    <button wire:click="increment({{ $product['id'] }})" id="increment" class="py-[6.7px] border-2 border-gray-400 text-gray-400 text-sm hover:bg-gray-200 hover:scale-110">˄</button>
                    <button wire:click="decrement({{ $product['id'] }})" id="decrement" class="py-[6.7px] border-2 border-gray-400 text-gray-400 text-sm hover:bg-gray-200 hover:scale-110">˅</button>
                </div>
